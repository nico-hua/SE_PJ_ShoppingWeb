<template>
  <div class="body">
    <div class="container1">
      <div class="wrap">
        <div class="nav-bar">
          <el-menu mode="horizontal" :ellipsis="false" router default-active="/midwaterbill">
...
export default {
  ...
  methods: {
    setTimeInterval() {
      ...
      let url = "/admin/getMiddleAccountRecorder?timeInterval=" + this.timeIntervalValue;
      this.$axios
          .get(url, {
            headers: {
              token: `${token}`
  ...
  mounted() {
    ...
    this.$axios
        .get('/admin/getMiddleAccountRecorder?timeInterval=0', {
          headers: {
            token: `${token}`
          }
        })
