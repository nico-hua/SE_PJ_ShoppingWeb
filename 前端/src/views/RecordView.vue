<template>
  <el-container>
    <el-header
      ><div class="content">
        <el-menu mode="horizontal" :ellipsis="false" router default-active="/recordview">
    ...
    <el-main
      ><el-table :data="tableData">
        <el-table-column prop="listTime" label="日期"> </el-table-column>
  ...
  mounted() {
    ...
    this.$axios
      ...
      .then((response) => {
        ...
        this.$axios
          .post(
            '/merchant/getTotalNumOfListRecord',
            { id: this.id },
            {
              headers: {
                token: `${token}`
